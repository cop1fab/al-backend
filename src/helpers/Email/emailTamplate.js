...
const emailTemplates = {
  ...
  <a style="background-color: #61a46e; padding: 12px 15px 12px 15px; color: #eee; font-size: 16px; text-decoration: none; margin-left: 20px; cursor: pointer;" href="http://127.0.0.1:8080/api/users/verify/$">Activate account</a>`
  }
};
